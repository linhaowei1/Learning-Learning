...
def get_args():
    ...
    parser.add_argument('--dictionary', type=str, default='./SST1/dict.json',
    ...
    parser.add_argument('--train-data', type=str, default='./SST1/train.json',
                        help='location of the training data, should be a json file')
    parser.add_argument('--val-data', type=str, default='./SST1/dev.json',
                        help='location of the development data, should be a json file')
    parser.add_argument('--test-data', type=str, default='./SST1/test.json',
